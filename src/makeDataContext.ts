import { makeContextObject } from "./makeContextObject";
import {
    IContextInterface,
 ...
 */
export function makeDataContext(data: IDataInterface, context: IContextInterface = {}): IDataContextInterface {
    const newData = makeContextObject(data, context);

    return {
        context,
        data: newData,
    } as IDataContextInterface;
}
